...
| PB-08 | Release acceptance and production readiness | In progress — production cutover preparation | 2026-09-17: Staging signed-in browser journeys and Drive status repair passed. The owner deferred live Drive/email/Telegram and physical-phone tests for this readiness pass; they remain unverified. Production native/encrypted backup, isolated Auth/fp restore and all 29 migrations 040–069 passed with 41 households, 75 members, 125 Auth users, 30 documents and zero invalid constraints before/after. Production-targeted Flutter and gateway candidates built; gateway offline scan has zero High/Critical. Public Worker route preservation, source/artifact freeze, unattended recovery, off-host backup assurance, fresh cutover backup and deployment/rollback approval remain. See docs/PB08_RELEASE_ACCEPTANCE.md and docs/PB08_PRODUCTION_CUTOVER.md. Not Released. |
