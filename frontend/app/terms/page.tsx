...
export default function TermsOfService() {
  return <main className="legal-page">
    <nav className="legal-nav"><a className="wordmark" href="/"><span>FD</span>Family Documents</a><a href="/prototype/index.html#auth">Sign in</a></nav>
    ...
    <footer className="legal-footer"><a href="/">Home</a><a href="/privacy">Privacy Policy</a><a href="mailto:support@familydocuments.app">Contact</a></footer>
  </main>;
}
