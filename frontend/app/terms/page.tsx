...
export default function TermsOfService() {
  return <main className="legal-page">
    <nav className="legal-nav"><Link className="wordmark" href="/"><span>FD</span>Family Documents</Link><a href="/prototype/index.html#auth">Sign in</a></nav>
    <article className="legal-document">
      <header><p className="eyebrow">Early-access agreement</p><h1>Terms of Service</h1><p className="legal-updated">Last updated 25 August 2026</p><p>These terms govern your use of Family Documents. By creating an account or using the service, you agree to them. If you do not agree, do not use the service. Questions can be sent to <a href="mailto:support@familydocuments.app">support@familydocuments.app</a>.</p></header>
      ...
      <section><h2>5. Connected storage and Google Drive</h2><p>Connected storage is optional and remains governed by the provider&apos;s terms. When you connect Google Drive, the app accesses only files or folders you explicitly choose under the permission shown by Google. You are responsible for maintaining access to your provider account. Disconnecting Family Documents does not delete provider originals.</p></section>
    ...
    <footer className="legal-footer"><Link href="/">Home</Link><a href="/privacy">Privacy Policy</a><a href="mailto:support@familydocuments.app">Contact</a></footer>
  </main>;
}
